    ...
    <main className="container-page py-10">
      ...
      <div className="mt-8 grid gap-4 lg:grid-cols-2">
        ...
        {(institutions ?? []).map((inst) => (
          <Card key={inst.id} className="border-border/70 p-6">
            ...
            <dl className="mt-5 grid gap-3 text-sm sm:grid-cols-2">
              <div>
                ...
                <dd className="mt-1 space-y-0.5">
                  {inst.rate_tiers.map((t, i) => (
                    <p key={i}>
                      up to {t.max_years} yr Â· {(t.annual_rate * 100).toFixed(1)}%
                    </p>
                  ))}
                </dd>
              </div>
              ...
              <div>
                ...
                <dd className="mt-1">
                  &gt;{(inst.collateral_percent * 100).toFixed(0)}% of value Â· released at{" "}
              ...
              <div>
                ...
                <dd className="mt-1">
                  {(inst.processing_fee_percent * 100).toFixed(1)}% processing Â·{" "}
              ...
              <div>
                ...
                <dd className="mt-1">
                  {inst.supports_uza_access_topup ? "Accepted" : "Not accepted"} Â·{" "}
                  {inst.min_term_years}â€“{inst.max_term_years} yr terms
                </dd>
              </div>
            </dl>
